  ...
  return (
    <main id="contenido">
      ...
      <section className="statement" id="nosotros" aria-labelledby="nosotros-title">
        ...
        <div className="statement-grid"><h2 id="nosotros-title">Criterio independiente.<br /><span>Confianza que permanece.</span></h2><div><p>Somos una firma de aseguramiento de información en Cartagena de Indias. Evaluamos los sistemas, los controles y los flujos de datos que sostienen la operación de las organizaciones. Nuestro propósito es aportar evidencia independiente para tomar decisiones con mayor confianza.</p><div className="values-row" aria-label="Valores corporativos"><span>Integridad</span><span>Objetividad</span><span>Confidencialidad</span><span>Escepticismo profesional</span></div></div></div>
      </section>
      ...
      <section className="contact" id="contacto"><div><p className="section-kicker light">Contacto</p><h2>Hagamos visible la confianza detrás de sus sistemas.</h2></div><div className="contact-details"><p className="contact-intro">Conversemos sobre las necesidades de su organización.</p><a href="mailto:garantiadigital@consultores.com">garantiadigital@consultores.com</a><a href="tel:+573126659850">+57 312 665 9850</a></div></section>
